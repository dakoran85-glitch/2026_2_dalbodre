...
const manitoSuccessMessages = [
  "보이지 않는 곳에서 끝까지 책임을 다해줘서 정말 고마워!", 
  "네가 있어서 오늘 우리 반이 한결 더 따뜻했어!",
  "우리가 널 믿은 만큼, 멋지게 해내 줘서 자랑스러워!", 
  "너의 헌신 덕분에 우리 모두가 기분 좋은 하루를 보냈어!",
  "작은 일도 솔선수범하는 네 모습이 진짜 멋졌어!", 
  "너의 상냥한 태도가 교실을 밝게 빛냈어, 고마워!",
  "모두를 위해 규칙을 지켜준 너의 배려에 박수를 보내!", 
  "어려운 미션인데도 긍정적인 마음으로 해내줘서 대단해!",
  "네가 뿌린 친절의 씨앗이 우리 반을 행복하게 만들었어!", 
  "혼자서도 묵묵히 제 몫을 다한 네가 진정한 영웅이야!",
  "우리를 위해 애써준 너의 예쁜 마음에 깊이 감사해!", 
  "너의 협동심 덕분에 오늘 우리 반이 더 끈끈해졌어!",
  "모범을 보여준 네 덕분에 나도 더 잘하고 싶어졌어!", 
  "조용하지만 강하게 우리를 지켜준 널 진심으로 존중해!",
  "너의 너그러운 미소가 오늘 하루의 피로를 싹 잊게 해!", 
  "언제나 믿음직스러운 너, 오늘 정말 최고였어!",
  "네가 보여준 책임감은 우리 모두에게 큰 귀감이 되었어.", 
  "너의 따뜻한 배려심이 교실 구석구석을 채웠단다!",
  "친구들을 먼저 생각하는 너의 헌신적인 마음에 감동했어!", 
  "미션을 완벽하게 해낸 너의 성실함에 큰 박수를 쳐!",
  "오늘 네가 만들어낸 긍정의 에너지가 정말 고마워!", 
  "너의 상냥한 말 한마디가 누군가에겐 큰 힘이 됐을 거야.",
  "언제나처럼 우리 반의 든든한 버팀목이 되어줘서 고마워!", 
  "너의 진심 어린 친절이 오늘 우리를 웃게 만들었어.",
  "스스로를 이겨내고 멋진 결과를 보여준 널 인정해!", 
  "너의 존중받아 마땅한 행동들이 오늘 하루를 빛냈어!",
  "함께하는 기쁨을 알려준 너의 노력에 진심으로 감사해.", 
  "누구보다 넓은 마음으로 미션을 해낸 네가 자랑스러워!",
  "우리를 하나로 만들어준 너의 협동심, 정말 멋지다!", 
  "보이지 않는 영웅으로 활약해 준 너의 오늘을 영원히 기억할게!"
];

const manitoFailMessages = [
  "오늘 하루도 고생했어! 내일은 네가 진짜 주인공이야!", 
  "실수해도 괜찮아, 우리는 언제나 한 팀이니까!",
  "마니또의 무게를 견디려 노력한 너의 하루를 응원해!", 
  "완벽하지 않아도 돼, 열심히 하려 했던 네 마음을 알아!",
  "괜찮아! 너의 다음 도전을 우리가 온 마음으로 응원할게!", 
  "오늘 배운 걸 바탕으로 내일 더 멋지게 성장할 널 믿어!",
  "결과보다 노력한 과정이 더 아름다운 법이야, 수고했어!", 
  "혼자 부담 갖지 마, 우리는 널 언제나 돕고 지지해!",
  "아쉬움은 털어버리고, 너의 밝은 미소를 다시 보여줘!", 
  "누구나 실수할 수 있어. 훌훌 털고 우리 함께 다시 시작하자!",
  "네가 우리 반이라는 사실만으로도 우린 이미 행복해!", 
  "실패는 성공의 어머니! 너의 내일이 더욱 기대되는걸?",
  "오늘의 아쉬움이 널 더 단단하고 배려 깊게 만들 거야.", 
  "네가 속상해하지 않도록 우리가 더 따뜻하게 안아줄게!",
  "비록 미션은 아쉬웠지만, 넌 항상 우리의 소중한 친구야.", 
  "스스로를 자책하지 마. 넌 충분히 잘 해내고 있어!",
  "너의 솔직한 노력만으로도 우리는 큰 감동을 받았어.", 
  "오늘 하루, 누구보다 마음 졸였을 너에게 수고의 박수를 쳐!",
  "다음에 다시 기회가 온다면 넌 분명 해낼 수 있을 거야!", 
  "우리 같이 부족한 점을 채워나가자, 언제나 곁에 있을게.",
  "네가 포기하지 않고 끝까지 하루를 마친 것에 감사해.", 
  "너의 짐을 우리가 나눠 질게, 우린 달보드레 반이니까!",
  "슬퍼하지 마! 네가 웃어야 교실이 다시 환해질 테니까.", 
  "너의 좋은 의도와 상냥한 마음은 우리가 다 알고 있단다.",
  "우린 결과로 널 판단하지 않아. 넌 그 자체로 소중해.", 
  "괜찮아, 툴툴 털고 내일은 함께 더 크게 웃어보자!",
  "너에게 너그러운 마음을 전할게. 넌 혼자가 아니야.", 
  "오늘의 실수가 내일의 널 더 반짝이게 만들어 줄 거야.",
  "마음 무거웠지? 이제 다 내려놓고 편안하게 쉬어.", 
  "우리가 널 믿는 마음은 변함없어. 기운 내, 파이팅!"
];

// 🌟 초기 역할 리스트 (객체 형태로 구조화)
const defaultRoles = [
  { name: '학급문고 정리', manual: '' }, { name: '우유 배달', manual: '' }, 
  { name: '다툼 중재자', manual: '' }, { name: '생활태도 체크', manual: '' }, 
  { name: '현령(칠/신/질)', manual: '' }, { name: '질서 관리', manual: '' }, 
  { name: '현령(문고/문/다)', manual: '' }, { name: '감찰사', manual: '' }, 
  { name: '칠판 정리', manual: '' }, { name: '생활 배출물 관리', manual: '' }, 
  { name: '현령(과/태/복/부)', manual: '' }, { name: '복사물 가져오기', manual: '' }, 
  { name: '가습기 관리', manual: '' }, { name: '현령(가/우/배)', manual: '' }, 
  { name: '과제 제출물 확인', manual: '' }, { name: '신발장 관리', manual: '' }, 
  { name: '부착물 관리', manual: '' }, { name: '문 닫기', manual: '' }, 
  { name: '향리', manual: '' }
];

const defaultStudents = [
  { id: 1, name: '금채율', role: '학급문고 정리', group: 1, isLeader: true },
  { id: 2, name: '김라희', role: '우유 배달', group: 1, isLeader: false },
  { id: 3, name: '김민지', role: '다툼 중재자', group: 1, isLeader: false },
  { id: 4, name: '김수은', role: '생활태도 체크', group: 1, isLeader: false },
  { id: 5, name: '김시우', role: '현령(칠/신/질)', group: 2, isLeader: true },
  { id: 6, name: '박서정', role: '질서 관리', group: 2, isLeader: false },
  { id: 7, name: '이하윤', role: '학급문고 정리', group: 2, isLeader: false },
  { id: 8, name: '장세아', role: '현령(문고/문/다)', group: 2, isLeader: false },
  { id: 9, name: '최예나', role: '우유 배달', group: 3, isLeader: true },
  { id: 10, name: '허수정', role: '감찰사', group: 3, isLeader: false },
  { id: 11, name: '황지인', role: '칠판 정리', group: 3, isLeader: false },
  { id: 12, name: '김도운', role: '생활 배출물 관리', group: 3, isLeader: false },
  { id: 13, name: '김윤재', role: '현령(과/태/복/부)', group: 4, isLeader: true },
  { id: 14, name: '김정현', role: '질서 관리', group: 4, isLeader: false },
  { id: 15, name: '김태영', role: '복사물 가져오기', group: 4, isLeader: false },
  { id: 16, name: '김해준', role: '칠판 정리', group: 4, isLeader: false },
  { id: 17, name: '박동민', role: '과제 제출물 확인', group: 5, isLeader: true },
  { id: 18, name: '서이환', role: '가습기 관리', group: 5, isLeader: false },
  { id: 19, name: '윤호영', role: '현령(가/우/배)', group: 5, isLeader: false },
  { id: 20, name: '이서준', role: '과제 제출물 확인', group: 5, isLeader: false },
  { id: 21, name: '이승현', role: '신발장 관리', group: 6, isLeader: true },
  { id: 22, name: '임유성', role: '질서 관리', group: 6, isLeader: false },
  { id: 23, name: '장세형', role: '다툼 중재자', group: 6, isLeader: false },
  { id: 24, name: '조승원', role: '부착물 관리', group: 6, isLeader: false },
  { id: 25, name: '차민서', role: '신발장 관리', group: 6, isLeader: false },
  { id: 26, name: '배지훈', role: '문 닫기', group: 6, isLeader: false }
];
...
const App = () => {
  ...
  // 🛡️ 역할 보너스 오류 방지 (글자가 아닐 경우의 예외 처리)
  ...
  // 🛡️ 백지화(Crash) 철벽 방어막: 데이터 형태 강제 변환
    ...
    const fetchInitial = async () => {
      ...
      try {
        ...
        if (data) {
          ...
          if (data.gachaConfig) {
            setGachaConfig(data.gachaConfig.mode ? data.gachaConfig : { mode: 'normal', normal: data.gachaConfig, special: defaultGachaSpecial });
          }
  ...
  useEffect(() => {
    ...
    if (DATABASE_URL && !DATABASE_URL.includes("복사한_주소")) {
       const dbUrl = `${DATABASE_URL.replace(/\/$/, '')}/classData_V2.json`;
       const configUpdates = { 
         shopItems, bossPresets, marketPresets, marketItems, 
         gachaConfig, manitoConfig, evoThresholds, tierThresholds, 
         targetScore, leaderConfig, rolesList 
       };
  ...
  const allStats = useMemo(() => {
    ...
    validHistory.forEach(rec => {
      let pT = rec.penaltyConfig?.timeout || 10; 
      let pS = rec.penaltyConfig?.subject || 10;
      try {
        const ind = JSON.parse(rec.rawInd || "{}"); 
        const per = JSON.parse(rec.rawPer || "{}"); 
        const tcomp = JSON.parse(rec.rawTComp || "{}");
        const tm = JSON.parse(rec.rawTm || "{}"); 
        const sb = JSON.parse(rec.rawSb || "{}");
  ...
  const handleGroupAllClear = (leaderId, groupNum, e) => {
    ...
    safeStudentsArray.filter(s => parseInt(s.group) === parseInt(groupNum)).forEach(s => { 
      newRoles[s.id] = true; 
      newPreps[s.id] = true; 
    });
    
    const newBonuses = {...leaderBonuses, [leaderId]: true};
    setCheckedStudents(newRoles); 
    setClassPrep(newPreps); 
    setLeaderBonuses(newBonuses);
  ...
  const handleGacha = (id) => {
    ...
    let resultMsg = ""; let reward = 0; let cumProb = 0; let isJackpot = false;
    ...
    if (isJackpot) { 
      playSound('jackpot'); setShowJackpot(true); setTimeout(() => setShowJackpot(false), 6000); 
    } else { 
      playSound('gacha'); alert(`[가챠 결과] ${resultMsg}`); 
    }
  };
  ...
  const showParticle = (x, y, text) => { 
    setParticle({ x, y, text, id: Date.now() }); 
  ...
  const handleEvolutionClick = (id, textsArray) => {
    ...
    setTooltipInfo({ id, text: randomText }); 
    setTimeout(() => setTooltipInfo({ id: null, text: '' }), 2500); 
  };

  // 🔥 관리실 기능 (직업, 상점, 이벤트 설정 등)
  const handleAddRole = () => {
...
return (
    <div className={`min-h-screen font-sans pb-24 transition-colors duration-700 ${activeBoss ? 'bg-red-950 text-red-50' : 'bg-slate-50 text-slate-900'}`}>
      ...
      {activeBoss && activeTab !== 'admin' && (
        <div className="max-w-7xl mx-auto px-4 md:px-6 my-6 animate-in slide-in-from-top duration-500">
      ...
      {/* 마니또 알림 바 */}
      {!activeBoss && activeTab !== 'admin' && (
         <div className="max-w-7xl mx-auto px-4 md:px-6 my-6 flex flex-col md:flex-row gap-4">
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-6">
              ...
              {filteredStudents.map(s => (
                <div key={s.id} className={`p-5 rounded-[32px] border-2 bg-white transition-all shadow-sm ${s.isLeader ? 'border-yellow-400 bg-yellow-50/30' : 'border-slate-100'} ${groupFilter !== 'all' ? 'transform scale-105 my-2' : ''}`}>
                  <div className="flex justify-between items-start mb-4">
                    ...
                    {s.isLeader && (
                       <button onClick={(e) => handleGroupAllClear(s.id, s.group, e)} className={`flex items-center gap-1 px-3 py-2 rounded-xl text-xs font-black transition-all active:scale-95 ${leaderBonuses[s.id] ? 'bg-slate-100 text-slate-300' : 'bg-blue-100 text-blue-600 hover:bg-blue-200'}`}>
                  ...
                  <div className="grid grid-cols-2 gap-1.5 mt-3">
                      <div className={`flex items-stretch border-2 rounded-xl overflow-hidden shadow-sm ${activeBoss ? 'border-red-900 bg-black' : 'border-red-100 bg-white'}`}>
                         <button onClick={(e) => handleAdjust(s.id, 'timeout', 1, e)} className={`flex-1 py-2 font-black text-[10px] transition-colors ${timeoutChecks[s.id] ? 'bg-red-500 text-white' : (activeBoss ? 'text-red-500 hover:bg-red-900/50' : 'bg-red-50 hover:bg-red-100 text-red-500')}`}>타임아웃 {timeoutChecks[s.id] > 0 && `(${timeoutChecks[s.id]})`}</button>
                         {timeoutChecks[s.id] > 0 && <button onClick={(e) => handleAdjust(s.id, 'timeout', -timeoutChecks[s.id], e)} className="px-2.5 bg-red-100 text-red-600 hover:bg-red-200 border-l border-red-200"><RotateCcw className="w-3.5 h-3.5"/></button>}
                      </div>
                      <div className={`flex items-stretch border-2 rounded-xl overflow-hidden shadow-sm ${activeBoss ? 'border-orange-900 bg-black' : 'border-orange-100 bg-white'}`}>
                         <button onClick={(e) => handleAdjust(s.id, 'subject', 1, e)} className={`flex-1 py-2 font-black text-[10px] transition-colors ${subjectChecks[s.id] ? 'bg-orange-500 text-white' : (activeBoss ? 'text-orange-500 hover:bg-orange-900/50' : 'bg-orange-50 hover:bg-orange-100 text-orange-500')}`}>전담지적 {subjectChecks[s.id] > 0 && `(${subjectChecks[s.id]})`}</button>
                         {subjectChecks[s.id] > 0 && <button onClick={(e) => handleAdjust(s.id, 'subject', -subjectChecks[s.id], e)} className="px-2.5 bg-orange-100 text-orange-600 hover:bg-orange-200 border-l border-orange-200"><RotateCcw className="w-3.5 h-3.5"/></button>}
                      </div>
                  </div>
                </div>
              ))}
        ...
        {activeTab === 'hyunryeong' && (
          <div className="animate-in slide-in-from-bottom-5 duration-500">
             <div className="bg-white rounded-[40px] p-6 md:p-10 border border-slate-200 shadow-sm mb-6">
                <h2 className="text-2xl md:text-3xl font-black mb-8 flex items-center gap-3 text-indigo-700"><ClipboardCheck className="w-8 h-8"/> 현령 업무 센터</h2>
                
                <div className="mb-10">
                   <p className="text-sm font-bold text-slate-400 mb-4">1. 자신의 직업을 선택하세요.</p>
                   <div className="flex flex-wrap gap-2 md:gap-3">
                      {safeRolesArray.map(role => (
                        <button key={role.name} onClick={() => setSelectedHyunRole(role)} className={`px-4 py-2 md:px-5 md:py-3 rounded-2xl font-black text-xs md:text-sm border-2 transition-all ${selectedHyunRole?.name === role.name ? 'bg-indigo-600 border-indigo-600 text-white shadow-lg scale-105' : 'bg-slate-50 border-slate-200 text-slate-500 hover:bg-slate-100'}`}>
                           {role.name}
                        </button>
                      ))}
                   </div>
                ...
                {selectedHyunRole && (
                  <div className="animate-in fade-in zoom-in duration-300">
                     <div className="bg-indigo-50 border-2 border-indigo-100 p-6 md:p-8 rounded-3xl mb-10">
                        <h4 className="font-black text-indigo-800 flex items-center gap-2 mb-4 text-lg md:text-xl"><BookOpen className="w-6 h-6"/> 업무 수행 지침 (매뉴얼)</h4>
                     ...
                     <div className="bg-slate-50 p-6 md:p-8 rounded-3xl border border-slate-200">
                        <div className="flex flex-col md:flex-row md:justify-between md:items-end mb-6 gap-2">
                           <h4 className="font-black text-slate-800 text-lg md:text-xl">반 전체 퀵 체크 리스트</h4>
                   ...
                   <div className="bg-white p-6 rounded-3xl border border-blue-100 shadow-sm">
                      ...
                      <div className="space-y-2">
                        {safeArray(shopItems).map(item => {
                          if (!item) return null;
                          return (
                            <button key={item.id} onClick={() => { if(!selectedStoreStudent) return alert("학생을 먼저 선택하세요."); handleStudentStoreBuy(parseInt(selectedStoreStudent), item); }} className="w-full p-4 rounded-2xl bg-blue-50 border-2 border-blue-100 flex justify-between items-center font-black hover:bg-blue-100 active:scale-95 transition-all text-blue-900">
                  ...
                  <section className="p-8 rounded-[40px] shadow-sm border bg-purple-900 border-purple-500 text-white animate-pulse">
                    ...
                    <div className="space-y-2">
                      {safeArray(marketItems).map(item => {
                        if(!item) return null;
                        return (
                          <button key={item.id} onClick={() => { if(!selectedMarketStudent) return alert("학생을 고르세요."); handleMarketBuy(parseInt(selectedMarketStudent), item); }} className="w-full bg-purple-800 hover:bg-purple-700 p-4 rounded-2xl flex justify-between items-center font-black transition-colors border border-purple-400 active:scale-95">
        ...
        {activeTab === 'info' && (
          <div className="space-y-6 animate-in zoom-in duration-500">
             ...
             <div className="bg-white rounded-[40px] p-8 border border-slate-200 shadow-sm mt-8 mb-12">
        ...
        {activeTab === 'admin' && isAuthenticated && (
          <div className="bg-white rounded-[40px] shadow-xl border border-slate-200 min-h-[750px] flex flex-col lg:flex-row overflow-hidden animate-in slide-in-from-right duration-300">
             ...
             <section className="flex-1 p-6 md:p-10 overflow-y-auto bg-white custom-scrollbar relative">
                     ...
                     {validHistory.length === 0 ? <div className="py-24 text-center text-slate-300 font-black border-4 border-dashed rounded-[40px]">기록이 없습니다.</div> : (
                       <div className="space-y-6">
                          {validHistory.map(rec => (
                            <div key={rec.id} className="bg-slate-50 p-6 md:p-8 rounded-[40px] flex flex-col md:flex-row justify-between items-center border border-slate-100 hover:border-blue-200 transition-all shadow-sm gap-4">
                               <div className="flex gap-6 md:gap-10 items-center w-full md:w-auto">
                                  <div className="text-center bg-white p-4 md:p-5 rounded-3xl shadow-sm border border-slate-100 min-w-[120px]"><p className="font-black text-slate-800 text-base md:text-lg">{rec.date}</p><p className="text-[10px] text-slate-400 mt-1 uppercase">{rec.time}</p></div>
                                  <div><h4 className="text-3xl md:text-4xl font-black text-slate-800 tracking-tight">{fmt(parseFloat(rec.total) || 0)}점</h4><p className="text-slate-500 font-bold text-xs md:text-sm mt-2 flex gap-4 md:gap-6"><span className="text-green-600 font-black">가점: +{fmt(parseFloat(rec.positive) || 0)}</span><span className="text-red-500 font-black">감점: -{fmt(parseFloat(rec.negative) || 0)}</span></p></div>
                               </div>
                ...
                {teacherTab === 'full-stats' && (
                  <div className="space-y-8">
                     ...
                     <div className="bg-white border border-slate-200 rounded-[30px] overflow-x-auto shadow-sm custom-scrollbar">
                        <table className="w-full text-left min-w-[800px]">
                           <thead className="bg-slate-50 text-[11px] font-black text-slate-500 uppercase tracking-widest border-b border-slate-200">
                              <tr>
                                 <th className="p-5 whitespace-nowrap">이름</th>
                                 <th className="p-5 text-center whitespace-nowrap">모둠 편성</th>
                                 <th className="p-5 text-center whitespace-nowrap">모둠장 임명</th>
                                 <th className="p-5 whitespace-nowrap">1인 1역(직업) 배정</th>
                                 {isAuthenticated === 'teacher' && <th className="p-5 text-center text-red-400 whitespace-nowrap">초기화</th>}
                              </tr>
                           </thead>
                           <tbody className="divide-y divide-slate-100">
                              {allStats.sort((a,b) => a.id - b.id).map((s) => (
                                <tr key={s.id} className="hover:bg-slate-50/50 transition-colors">
                                   <td className="p-5 font-black text-slate-700 text-base whitespace-nowrap">{s.name}</td>
                                   ...
                                   <td className="p-5 text-center">
                                      <button onClick={() => handleStudentFieldChange(s.id, 'isLeader', !s.isLeader)} className={`px-4 py-2 rounded-xl border-2 text-xs font-black transition-all active:scale-95 whitespace-nowrap ${s.isLeader ? 'bg-yellow-100 border-yellow-400 text-yellow-800 shadow-sm' : 'bg-white border-slate-200 text-slate-400 hover:bg-slate-100'}`} title="클릭하여 토글">
                                         {s.isLeader ? '👑 모둠장' : '모둠원'}
                                      </button>
                                   </td>
                                   <td className="p-5">
                                      <select value={s.role} onChange={(e) => handleStudentFieldChange(s.id, 'role', e.target.value)} className="bg-white border border-slate-200 rounded-xl px-4 py-2 text-sm font-black text-slate-700 outline-none focus:border-indigo-400 w-full shadow-sm cursor-pointer hover:bg-slate-50 min-w-[150px]">
                                         <option value="">-- 역할 없음 --</option>
                                         {safeRolesArray.map(r => <option key={r.name} value={r.name}>{r.name}</option>)}
                                      </select>
                                   </td>
                                   {isAuthenticated === 'teacher' && (
                                     <td className="p-5 text-center"><button onClick={() => resetGoalIndividualScore(s.id)} className="text-[10px] font-black bg-red-50 text-red-500 border border-red-100 px-3 py-2 rounded-xl hover:bg-red-100 whitespace-nowrap">잔여 0p</button></td>
                                   )}
                                </tr>
                              ))}
                           </tbody>
                               ...
                               <div className="space-y-3 max-h-[300px] overflow-y-auto pr-2 custom-scrollbar">
                                 {safeRolesArray.map(role => (
                                    <div key={role.name} className="bg-white p-4 rounded-2xl border border-indigo-100 shadow-sm flex flex-col gap-2">
                                       ...
                                       <textarea 
                                          placeholder="현령 센터에 표시될 업무 지침을 적어주세요." 
                                          value={role.manual} 
                                          onChange={(e) => { const newRoles = safeRolesArray.map(r => r.name === role.name ? {...r, manual: e.target.value} : r); setRolesList(newRoles); syncToFirebase({rolesList: newRoles}); }} 
                                          className="w-full h-20 p-3 bg-slate-50 border border-slate-100 rounded-xl text-xs font-bold outline-none focus:border-indigo-300 resize-none"
                                       />
                                    </div>
                                 ))}
                               </div>
                ...
                {teacherTab === 'store' && isAuthenticated === 'teacher' && (
                  <div className="space-y-8 h-full flex flex-col">
                     <div className="flex justify-between items-end mb-6 px-2">
                        <h3 className="text-2xl md:text-3xl font-black text-slate-800 border-l-8 border-amber-500 pl-4 md:pl-6">상점 결제 및 가챠 커스텀</h3>
                     </div>
                     
                     <div className="bg-slate-50 p-6 md:p-8 rounded-[40px] border border-slate-200 mb-8">
                        <div className="flex justify-between items-end mb-6">
                           <h4 className="text-lg md:text-xl font-black text-slate-800 flex items-center gap-2"><ShoppingCart className="text-slate-400"/> 다중 결제 시스템</h4>
                        ...
                        <div className="flex flex-wrap gap-3 border-t border-slate-200 pt-6">
                           {safeArray(shopItems).map(item => {
                             if(!item) return null;
                             return (
                             <button key={item.id} onClick={() => handleMultiConsume(item.price, item.name)} className="flex-1 min-w-[120px] md:min-w-[150px] bg-white border border-blue-200 text-blue-600 p-4 rounded-2xl font-black text-sm shadow-sm hover:bg-blue-50 active:scale-95">
                     ...
                     <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                        <div className="bg-white p-6 md:p-8 rounded-[40px] border border-slate-200 shadow-sm">
                          <h4 className="text-lg md:text-xl font-black text-slate-800 mb-6 flex items-center gap-2"><Settings className="text-slate-400"/> 상점 아이템 등록</h4>
                          <div className="flex flex-col sm:flex-row gap-3 mb-6">
                            <input type="text" placeholder="상품명" value={newItemName} onChange={(e) => setNewItemName(e.target.value)} className="flex-1 bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 font-bold outline-none focus:border-blue-400"/>
                        ...
                        <div className="bg-yellow-50 p-6 md:p-8 rounded-[40px] border border-yellow-200 shadow-sm relative overflow-hidden">
                          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 border-b border-yellow-200/50 pb-4 gap-4">
                             <h4 className="text-lg md:text-xl font-black text-yellow-800 flex items-center gap-2"><Star className="w-5 h-5"/> 가챠 조작기</h4>
                             <button onClick={() => { const newMode = gachaConfig.mode === 'special' ? 'normal' : 'special'; setGachaConfig({...gachaConfig, mode: newMode}); syncToFirebase({gachaConfig: {...gachaConfig, mode: newMode}}); }} className={`px-4 py-2 rounded-xl text-xs font-black shadow-md transition-all active:scale-95 w-full sm:w-auto ${gachaConfig.mode === 'special' ? 'bg-purple-600 text-white' : 'bg-yellow-400 text-yellow-900'}`}>
                               {gachaConfig.mode === 'special' ? '✨ 동민신 모드 ON' : '🎁 일반 행운 모드'}
                             </button>
                          </div>

                          <div className="flex mb-4 gap-2 border-b border-yellow-200/50 pb-2">
                             <button onClick={() => setGachaEditTab('normal')} className={`px-3 py-2 text-xs md:text-sm font-black rounded-xl transition-colors ${gachaEditTab === 'normal' ? 'bg-white text-yellow-800 shadow-sm border border-yellow-200' : 'text-yellow-600/50 hover:bg-yellow-100'}`}>일반 세팅</button>
                             <button onClick={() => setGachaEditTab('special')} className={`px-3 py-2 text-xs md:text-sm font-black rounded-xl transition-colors ${gachaEditTab === 'special' ? 'bg-purple-600 text-white shadow-sm' : 'text-yellow-600/50 hover:bg-yellow-100'}`}>✨ 동민신 세팅</button>
                          </div>
                          
                          <div className={`p-4 md:p-6 rounded-2xl border ${gachaEditTab === 'special' ? 'bg-purple-50 border-purple-200' : 'bg-white border-yellow-200'}`}>
                             <div className="flex items-center gap-3 mb-5">
                                <span className={`font-black text-sm ${gachaEditTab === 'special' ? 'text-purple-800' : 'text-yellow-800'}`}>1회 비용:</span>
                                <input type="number" value={gachaConfig[gachaEditTab]?.cost || 0} onChange={(e)=>{ const newConfig = {...gachaConfig, [gachaEditTab]: {...gachaConfig[gachaEditTab], cost: parseFloat(e.target.value)||0}}; setGachaConfig(newConfig); syncToFirebase({gachaConfig: newConfig}); }} className={`w-20 text-center border-2 rounded-xl py-1.5 font-black outline-none ${gachaEditTab === 'special' ? 'bg-purple-100 border-purple-300 text-purple-900' : 'bg-slate-50 border-yellow-200 text-yellow-900'}`}/>
                             </div>
                             <div className="space-y-2">
                                {['t1', 't2', 't3', 't4'].map((t, i) => (
                                  <div key={t} className={`flex flex-wrap md:flex-nowrap gap-2 items-center p-3 rounded-xl border ${gachaEditTab === 'special' ? 'bg-white border-purple-100' : 'bg-slate-50 border-slate-100'}`}>
                                     <span className="font-black text-slate-300 w-4 text-xs">{i+1}</span>
                                     <input type="text" value={gachaConfig[gachaEditTab]?.[t]?.name || ''} onChange={(e)=>{ const newConfig = {...gachaConfig, [gachaEditTab]: {...gachaConfig[gachaEditTab], [t]: {...gachaConfig[gachaEditTab][t], name: e.target.value}}}; setGachaConfig(newConfig); syncToFirebase({gachaConfig: newConfig}); }} className="flex-1 min-w-[100px] bg-transparent text-xs font-bold outline-none" placeholder="당첨 메세지"/>
                                     <div className="flex gap-1 items-center">
                                       <input type="number" value={gachaConfig[gachaEditTab]?.[t]?.prob || 0} onChange={(e)=>{ const newConfig = {...gachaConfig, [gachaEditTab]: {...gachaConfig[gachaEditTab], [t]: {...gachaConfig[gachaEditTab][t], prob: parseFloat(e.target.value)||0}}}; setGachaConfig(newConfig); syncToFirebase({gachaConfig: newConfig}); }} className="w-12 bg-white border border-slate-200 rounded-lg px-1 py-1.5 text-xs font-bold outline-none text-center" placeholder="%"/>
                                       <span className="text-[10px] font-black text-slate-400 mr-2">%</span>
                                       <input type="number" value={gachaConfig[gachaEditTab]?.[t]?.reward || 0} onChange={(e)=>{ const newConfig = {...gachaConfig, [gachaEditTab]: {...gachaConfig[gachaEditTab], [t]: {...gachaConfig[gachaEditTab][t], reward: parseFloat(e.target.value)||0}}}; setGachaConfig(newConfig); syncToFirebase({gachaConfig: newConfig}); }} className="w-12 bg-amber-50 border border-amber-200 text-amber-700 rounded-lg px-1 py-1.5 text-xs font-black outline-none text-center" placeholder="보상"/>
                ...
                {teacherTab === 'events' && isAuthenticated === 'teacher' && (
                  <div className="space-y-8">
                     ...
                     <div className="bg-yellow-50 p-6 md:p-8 rounded-[30px] border-2 border-yellow-200 shadow-sm mb-8">
                     ...
                     <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                        <div className="bg-red-50 p-6 md:p-8 rounded-[40px] border border-red-200 shadow-sm flex flex-col">
                           <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                              ...
                              {activeBoss && <button onClick={() => { setActiveBoss(null); syncToFirebase({ activeBoss: null, bossAttacks: {} }); }} className="w-full sm:w-auto bg-slate-800 text-white px-4 py-2 rounded-xl text-xs font-black shadow-md hover:bg-slate-700">레이드 강제 종료</button>}
                           </div>
                           ...
                           <div className="space-y-3 mb-6 max-h-[250px] overflow-y-auto pr-2 custom-scrollbar">
                              {safeArray(bossPresets).map(b => {
                                if(!b) return null;
                                return (
                                <div key={b.id} className={`p-4 md:p-5 rounded-2xl border-2 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 transition-all ${activeBoss?.id === b.id ? 'bg-red-600 border-red-500 text-white shadow-lg scale-[1.02] my-2' : 'bg-white border-red-100 hover:border-red-300'}`}>
                                   <div className="w-full sm:w-auto">
                                      <p className="font-black text-sm md:text-base mb-1">{b.name || '이름 없음'}</p>
                                      <p className={`text-[10px] font-bold mb-2 ${activeBoss?.id === b.id ? 'text-red-200' : 'text-slate-500'} truncate w-full sm:w-40`}>{b.desc}</p>
                        ...
                        <div className="bg-purple-50 p-6 md:p-8 rounded-[30px] border-2 border-purple-200 shadow-sm flex flex-col">
                           <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                              <h4 className="text-xl font-black text-purple-800 flex items-center gap-2"><Lock className="text-purple-500"/> 블랙마켓 관리소</h4>
                              {activeMarket && <button onClick={() => { setActiveMarket(null); syncToFirebase({ activeMarket: null }); }} className="w-full sm:w-auto bg-slate-800 text-white px-4 py-2 rounded-xl text-xs font-black shadow-md hover:bg-slate-700">마켓 강제 닫기</button>}
                           </div>
                           ...
                           <div className="space-y-3 mb-6 max-h-[150px] overflow-y-auto pr-2 custom-scrollbar">
                              {safeArray(marketPresets).map(m => {
                                if(!m) return null;
                                return (
                                <div key={m.id} className={`p-4 md:p-5 rounded-2xl border-2 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 transition-all ${activeMarket?.id === m.id ? 'bg-purple-600 border-purple-500 text-white shadow-lg scale-[1.02] my-2' : 'bg-white border-purple-100 hover:border-purple-300'}`}>
                                   <div className="w-full sm:w-auto">
                                      <p className="font-black text-sm md:text-base mb-1">{m.name}</p>
                                      <p className={`text-[10px] font-bold ${activeMarket?.id === m.id ? 'text-purple-200' : 'text-slate-500'} truncate w-full sm:w-40`}>{m.desc}</p>
                                   </div>
                                   {activeMarket?.id !== m.id ? (
                                      <div className="flex flex-row sm:flex-col gap-2 w-full sm:w-auto">
                                        <button onClick={() => { setActiveMarket(m); syncToFirebase({ activeMarket: m }); }} className="flex-1 sm:flex-none bg-purple-100 text-purple-700 px-4 py-2 rounded-xl text-xs font-black hover:bg-purple-200 shadow-sm">오픈</button>
                                        <button onClick={() => handleDeleteMarket(m.id)} className="flex-1 sm:flex-none text-slate-400 hover:text-red-500 text-xs font-bold text-center bg-slate-50 sm:bg-transparent rounded-xl sm:rounded-none py-2 sm:py-0 border sm:border-none border-slate-200">삭제</button>
                                      </div>
                                   ) : <span className="bg-white/20 px-3 py-1.5 rounded-lg text-xs font-black animate-pulse text-white w-full sm:w-auto text-center">영업 중!</span>}
                                </div>
                              )})}
                           </div>
                ...
                {teacherTab === 'settings' && isAuthenticated === 'teacher' && (
                  <div className="space-y-8">
                     ...
                     <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 mb-8">
                        <div className="bg-indigo-50 p-6 md:p-8 rounded-[40px] border border-indigo-200 shadow-sm flex flex-col justify-between">
                           <div>
                             <h4 className="text-lg md:text-xl font-black text-indigo-800 mb-2 flex items-center gap-2"><Crown className="w-6 h-6"/> 모둠장 올클리어 보너스</h4>
                             <p className="text-indigo-600/80 font-bold text-xs md:text-sm mb-6 leading-relaxed">모둠장이 자기 모둠원들의 역할을 전부 챙겨서 올클리어 스킬을 발동했을 때 즉시 지급되는 리더십 보너스입니다.</p>
                           </div>
                           <div className="flex items-center gap-4 bg-white p-4 rounded-2xl border border-indigo-100 w-full sm:w-fit shadow-sm">
                              <input type="number" value={leaderConfig.allClearBonus || 0} onChange={(e)=>{ const val = parseFloat(e.target.value)||0; setLeaderConfig({...leaderConfig, allClearBonus: val}); syncToFirebase({leaderConfig: {...leaderConfig, allClearBonus: val}}); }} className="w-20 text-center font-black text-indigo-600 text-xl md:text-2xl p-2 rounded-xl bg-slate-50 outline-none focus:border-indigo-300 border border-transparent" />
                              <span className="font-black text-indigo-800 text-sm md:text-base">포인트 (p)</span>
                           </div>
                        </div>

                        <div className="bg-slate-50 p-6 md:p-8 rounded-[40px] border border-slate-200 shadow-sm flex flex-col justify-between">
                           <div>
                             <h4 className="text-lg md:text-xl font-black text-slate-800 mb-2 flex items-center gap-2"><Settings className="w-6 h-6"/> 학급 총점 치트키</h4>
                             <p className="text-slate-500 font-bold text-xs md:text-sm mb-6 leading-relaxed">과거 마감 기록이 누락되었거나, 이벤트로 학급 전체 총점을 크게 보정해야 할 때 사용하는 수동 조절기입니다.</p>
                           </div>
                           <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm flex flex-col gap-4">
                             <div className="flex justify-between items-center">
                               <span className="font-black text-xs md:text-sm text-slate-400">현재 보정된 점수:</span>
                               <span className="text-xl md:text-2xl font-black text-blue-600">{manualTotalBonus > 0 ? '+' : ''}{manualTotalBonus}p</span>
                             </div>
                             <div className="flex flex-col sm:flex-row gap-2">
                               ...
                               <div className="flex gap-2">
                                 <button onClick={() => { const val = manualTotalBonus + (parseFloat(manualAdjustAmount)||0); setManualTotalBonus(val); syncToFirebase({manualTotalBonus: val}); setManualAdjustAmount(''); }} className="flex-1 sm:flex-none bg-blue-600 text-white px-5 py-3 rounded-xl font-black hover:bg-blue-700 active:scale-95 transition-all shadow-md">적용</button>
                                 <button onClick={() => { setManualTotalBonus(0); syncToFirebase({manualTotalBonus: 0}); }} className="flex-1 sm:flex-none bg-slate-200 text-slate-600 px-4 py-3 rounded-xl font-black hover:bg-slate-300 active:scale-95 transition-all">0점</button>
                               </div>
                             </div>
                           </div>
                        </div>
                     ...
                     <div className="bg-white p-6 md:p-8 rounded-[40px] border border-slate-200 shadow-sm mb-8">
                        <h4 className="text-lg md:text-xl font-black text-slate-800 mb-6 flex items-center gap-2"><SlidersHorizontal className="w-6 h-6 text-blue-500"/> 진화 커트라인 설정 (10단계)</h4>
                        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                           <div className="bg-slate-50 p-6 md:p-8 rounded-3xl border border-slate-100">
                              <p className="text-xs md:text-sm font-black text-slate-500 uppercase tracking-widest mb-6 flex items-center gap-2">🥚 잔여 점수 기준 진화</p>
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                 {[ { id: 'e1', label: '1. 잠든 알', icon: '🥚' }, { id: 'e2', label: '2. 깨는 알', icon: '🐣' }, { id: 'e3', label: '3. 병아리', icon: '🐥' }, { id: 'e4', label: '4. 발랄 병아리', icon: '🐤' }, { id: 'e5', label: '5. 닭', icon: '🐔' }, { id: 'e6', label: '6. 새', icon: '🕊️' }, { id: 'e7', label: '7. 독수리', icon: '🦅' }, { id: 'e8', label: '8. 유니콘', icon: '🦄' }, { id: 'e9', label: '9. 꼬마 드래곤', icon: '🐲' }].map(item => (
                                   <div key={item.id} className="flex justify-between items-center bg-white p-3 md:p-4 rounded-xl border border-slate-200 shadow-sm">
                                      <span className="font-bold text-xs md:text-sm text-slate-700 truncate mr-2 flex items-center gap-2">{item.icon} {item.label}</span>
                                      <div className="flex items-center gap-1 shrink-0"><span className="text-[10px] md:text-xs text-slate-400">~</span><input type="number" value={evoThresholds[item.id]} onChange={(e) => { const newTh = {...evoThresholds, [item.id]: parseInt(e.target.value)||0}; setEvoThresholds(newTh); syncToFirebase({evoThresholds: newTh}); }} className="w-12 md:w-14 text-center bg-slate-50 border border-slate-200 rounded-lg py-1.5 font-black text-[10px] md:text-xs outline-none focus:border-blue-400"/></div>
                                   </div>
                                 ))}
                              </div>
                           </div>
                           ...
                           <div className="bg-slate-50 p-6 md:p-8 rounded-3xl border border-slate-100">
                              <p className="text-xs md:text-sm font-black text-slate-500 uppercase tracking-widest mb-6 flex items-center gap-2">🌲 누적 점수 기준 칭호</p>
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                 {[ { id: 't1', label: '1. 잠든 씨앗', icon: '🤎' }, { id: 't2', label: '2. 새싹', icon: '🌱' }, { id: 't3', label: '3. 줄기', icon: '🌿' }, { id: 't4', label: '4. 클로버', icon: '☘️' }, { id: 't5', label: '5. 꽃봉오리', icon: '🌷' }, { id: 't6', label: '6. 꽃', icon: '🌻' }, { id: 't7', label: '7. 열매', icon: '🍎' }, { id: 't8', label: '8. 나무', icon: '🌳' }, { id: 't9', label: '9. 숲', icon: '🌲' }].map(item => (
                                   <div key={item.id} className="flex justify-between items-center bg-white p-3 md:p-4 rounded-xl border border-slate-200 shadow-sm">
                                      <span className="font-bold text-xs md:text-sm text-slate-700 truncate mr-2 flex items-center gap-2">{item.icon} {item.label}</span>
                                      <div className="flex items-center gap-1 shrink-0"><span className="text-[10px] md:text-xs text-slate-400">~</span><input type="number" value={tierThresholds[item.id]} onChange={(e) => { const newTh = {...tierThresholds, [item.id]: parseInt(e.target.value)||0}; setTierThresholds(newTh); syncToFirebase({tierThresholds: newTh}); }} className="w-12 md:w-14 text-center bg-slate-50 border border-slate-200 rounded-lg py-1.5 font-black text-[10px] md:text-xs outline-none focus:border-green-400"/></div>
                                   </div>
                                 ))}
                              </div>
                           </div>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-slate-200 px-2 py-3 flex justify-around items-center z-50 shadow-[0_-10px_30px_rgba(0,0,0,0.05)] pb-safe">
         <button onClick={() => setActiveTab('classroom')} className={`flex flex-col items-center gap-1.5 flex-1 transition-all ${activeTab === 'classroom' ? 'text-blue-600 scale-110 -translate-y-2' : 'text-slate-400 hover:text-blue-400'}`}>
            ...
            <span className="text-[10px] md:text-[11px] font-black">교실</span>
         </button>
         <button onClick={() => setActiveTab('hyunryeong')} className={`flex flex-col items-center gap-1.5 flex-1 transition-all ${activeTab === 'hyunryeong' ? 'text-indigo-600 scale-110 -translate-y-2' : 'text-slate-400 hover:text-indigo-400'}`}>
            ...
            <span className="text-[10px] md:text-[11px] font-black">현령</span>
         </button>
         <button onClick={() => setActiveTab('shop')} className={`flex flex-col items-center gap-1.5 flex-1 transition-all ${activeTab === 'shop' ? 'text-yellow-600 scale-110 -translate-y-2' : 'text-slate-400 hover:text-yellow-400'}`}>
            ...
            <span className="text-[10px] md:text-[11px] font-black">상점</span>
         </button>
         <button onClick={() => setActiveTab('info')} className={`flex flex-col items-center gap-1.5 flex-1 transition-all ${activeTab === 'info' ? 'text-green-600 scale-110 -translate-y-2' : 'text-slate-400 hover:text-green-400'}`}>
            ...
            <span className="text-[10px] md:text-[11px] font-black">반 정보</span>
         </button>
         <button onClick={() => isAuthenticated ? setActiveTab('admin') : setShowModal('password')} className={`flex flex-col items-center gap-1.5 flex-1 transition-all ${activeTab === 'admin' ? 'text-slate-900 scale-110 -translate-y-2' : 'text-slate-400 hover:text-slate-700'}`}>
            ...
            <span className="text-[10px] md:text-[11px] font-black">관리</span>
         </button>
      </nav>

      {/* 비밀번호 모달 */}
      {showModal === 'password' && (
        <div className="fixed inset-0 bg-slate-900/90 backdrop-blur-xl flex items-center justify-center p-4 md:p-6 z-[9999]">
          <div className="bg-white rounded-[40px] md:rounded-[50px] p-8 md:p-12 w-full max-w-sm shadow-2xl animate-in zoom-in-95 duration-200 border border-slate-100">
            <div className="text-center mb-8">
               <div className="bg-slate-100 w-20 h-20 md:w-24 md:h-24 rounded-[30px] flex items-center justify-center mx-auto mb-6 text-slate-700 shadow-inner"><Lock className="w-8 h-8 md:w-10 md:h-10" /></div>
            ...
            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && handleLogin()} className="w-full text-center text-3xl md:text-4xl tracking-[15px] md:tracking-[20px] font-black p-4 md:p-6 border-4 border-slate-100 rounded-2xl md:rounded-3xl outline-none mb-8 bg-slate-50 focus:border-indigo-400 transition-colors" autoFocus placeholder="••••" />
            <div className="flex gap-4">
              <button onClick={() => setShowModal(null)} className="flex-1 py-4 md:py-5 rounded-xl md:rounded-2xl font-black text-slate-500 text-base md:text-lg bg-slate-100 hover:bg-slate-200 transition-colors">취소</button>
              <button onClick={handleLogin} className="flex-1 py-4 md:py-5 rounded-xl md:rounded-2xl font-black bg-slate-800 text-white text-base md:text-lg shadow-xl hover:bg-slate-900 transition-all active:scale-95">접속</button>
            </div>
          </div>
        </div>
      )}
      ...
      {showJackpot && (
        <div className="fixed inset-0 flex items-center justify-center z-[9999] bg-black/80 backdrop-blur-sm animate-in fade-in duration-300">
          <div className="bg-gradient-to-b from-yellow-300 to-yellow-500 p-12 md:p-20 rounded-[40px] md:rounded-[60px] shadow-[0_0_100px_rgba(253,224,71,0.8)] text-center animate-bounce max-w-sm md:max-w-2xl mx-4">
            <div className="text-7xl md:text-9xl mb-4">🎰🎉👑</div>
            <h2 className="text-5xl md:text-7xl font-black text-red-600 mb-4 drop-shadow-lg">JACKPOT!!</h2>
            <p className="text-2xl md:text-4xl font-black text-yellow-900">엄청난 행운이 터졌습니다!</p>
            <div className="mt-8 text-3xl md:text-5xl font-black text-white bg-red-600 px-6 py-3 md:px-8 md:py-4 rounded-full inline-block border-4 md:border-8 border-yellow-200 animate-pulse">
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[9999] bg-slate-900/95 backdrop-blur-md px-4 md:px-6">
          {manitoRevealState === 'loading' ? (
            <div className="text-center animate-pulse">
              ...
              <h2 className="text-3xl md:text-6xl font-black text-yellow-400 tracking-widest break-keep-all">오늘의 마니또는 과연...?</h2>
            </div>
          ) : (
            <div className={`p-8 md:p-20 rounded-[40px] md:rounded-[60px] text-center animate-in zoom-in duration-500 max-w-4xl w-full shadow-2xl relative overflow-hidden ${manitoRevealState === 'success' ? 'bg-gradient-to-b from-blue-600 to-indigo-800 text-white border-4 md:border-8 border-blue-400' : 'bg-slate-800 text-slate-100 border-4 border-slate-600'}`}>
              ...
              <div className="relative z-10">
                <div className="text-6xl md:text-9xl mb-4 md:mb-6 animate-bounce">{manitoRevealState === 'success' ? '👼✨' : '💛'}</div>
                <h2 className="text-4xl md:text-7xl font-black mb-4 md:mb-6 drop-shadow-lg">{effectiveManitoName}</h2>
                <p className="text-lg md:text-2xl font-bold mb-8 md:mb-12 opacity-90 break-keep-all">{manitoRevealState === 'success' ? '완벽한 수호자 미션 달성!' : '미션은 실패했지만 고생 많았어요!'}</p>
                <div className="bg-black/30 backdrop-blur-md p-6 md:p-10 rounded-[20px] md:rounded-[30px] border border-white/20 shadow-inner">
                   <p className="text-[10px] md:text-sm font-black uppercase tracking-widest mb-3 md:mb-4 opacity-70">모두 함께 외쳐주세요!</p>
                   <p className="text-xl md:text-4xl font-black leading-snug break-keep-all">"{manitoRevealMsg}"</p>
                </div>
                <button onClick={closeManitoReveal} className={`mt-8 md:mt-10 font-black px-8 py-4 md:px-12 md:py-5 rounded-full text-lg md:text-xl hover:scale-105 transition-transform shadow-xl w-full md:w-auto ${manitoRevealState === 'success' ? 'bg-white text-blue-900' : 'bg-slate-600 text-white hover:bg-slate-500'}`}>확인 완료</button>
              </div>
            </div>
          )}
        </div>
      ...
      {/* 보스 클리어 모달 */}
      {showModal === 'bossClear' && (
        <div className="fixed inset-0 flex items-center justify-center z-[9999] bg-white/80 backdrop-blur-sm animate-in fade-in duration-500 px-4">
          <div className="bg-gradient-to-br from-yellow-100 to-yellow-300 border-[8px] md:border-[12px] border-yellow-400 p-12 md:p-20 rounded-[40px] md:rounded-[80px] shadow-2xl text-center transform hover:scale-105 transition-transform duration-500 max-w-sm md:max-w-2xl w-full">
            <div className="text-7xl md:text-9xl mb-4 md:mb-6 animate-bounce">👼</div>
            <h2 className="text-4xl md:text-6xl font-black text-yellow-600 mb-4 md:mb-6 drop-shadow-md">보스 정화 완료!</h2>
            <p className="text-xl md:text-3xl font-black text-slate-700 mb-4 break-keep-all">26명의 마음이 모여 기적이 일어났어요!</p>
            <p className="text-lg md:text-2xl font-black text-blue-600 bg-white/50 inline-block px-4 py-2 md:px-6 md:py-2 rounded-full mt-2 md:mt-4">보너스 점수 획득!</p>
          </div>
        </div>
      )}
      ...
      {/* 성공 팝업 */}
      {showModal === 'success' && (
        <div className="fixed inset-0 flex items-center justify-center z-[9999] pointer-events-none animate-in fade-in duration-300 px-4">
          <div className="bg-white border-[8px] md:border-[12px] border-yellow-400 p-10 md:p-20 rounded-[40px] md:rounded-[80px] shadow-2xl animate-bounce text-center w-full max-w-md md:max-w-2xl">
             <h2 className="text-5xl md:text-7xl font-black text-blue-600 mb-4 md:mb-6">🎉 마감 성공! 🎉</h2>
             <p className="text-2xl md:text-4xl font-black text-slate-500">기록이 저장되었습니다.</p>
          </div>
        </div>
      )}
